...
<form action="" method="post">
    ...
    <fieldset>
        ...
        <div class="displayFlex">
            <div class="margin">
                <label for="cpf_membro">CPF</label><br>
        ...
        <div class="displayFlex">
            ...
            <div class="margin">
                <label for="uf_nascimento_membro">UF de Nascimento</label><br>
                <input type="text" name="uf_nascimento_membro" id="uf_nascimento_membro" required autocomplete="random-string" value="<?= ($membros[0]['uf_nascimento_membro']) ?? '' ?>">
            </div>

            <div class="margin">
                <label for="municipio_nascimento_membro">Município de Nascimento</label><br>
                <input type="text" name="municipio_nascimento_membro" id="municipio_nascimento_membro" required autocomplete="random-string" value="<?= ($membros[0]['municipio_nascimento_membro']) ?? '' ?>">
            </div>
