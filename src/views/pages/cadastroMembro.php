    ...
    <fieldset>
        ...
        <div class="displayFlex">
            ...
            <div class="margin">
                ...
                <input type="text" name="uf_nascimento_membro" id="uf_nascimento_membro" required autocomplete="random-string">
            </div>

            <div class="margin">
                <label for="municipio_nascimento_membro">Município de Nascimento</label><br>
                <input type="text" name="municipio_nascimento_membro" id="municipio_nascimento_membro" required autocomplete="random-string">
            </div>
