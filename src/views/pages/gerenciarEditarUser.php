        ...
        <fieldset>
            ...
            <div class="displayFlex">
                <div class="margin">
                    ...
                    <input type="text" autocomplete="random-string" name="user" id="user" required> <br><br>
                </div>

                <div class="margin">
                    <label for="e-mail">E-mail</label> <br>
                    <input type="text" autocomplete="random-string" name="email" id="email" required> <br><br>
                </div>
