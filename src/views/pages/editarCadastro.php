    ...
    <form action="" method="post">
        ...
        <fieldset>
            ...
            <div class="displayFlex">
                <div class="margin">
                    <label for="cpf_socio" id="label-cpf">CPF</label><br>
            ...
            <div class="displayFlex">
                ...
                <div class="margin">
                    ...
                    <select name="uf_nascimento_socio" id="uf_nascimento_socio" required>
                        <option><?= ($socios[0]['uf_nascimento_socio']) ?? '' ?></option>
                    </select>
                </div>

                <div class="margin">
                    <label for="municipio_nascimento_socio">Município de Nascimento</label><br>
                    <select name="municipio_nascimento_socio" id="municipio_nascimento_socio">
                        <option><?= ($socios[0]['municipio_nascimento_socio']) ?? '' ?></option>
                    </select>
                </div>
            ...
            <div class="displayFlex">
                <div class="margin">
                    ...
                    <input type="text" name="cep_socio" id="inputCEP2" required autocomplete="random-string" value="<?= ($socios[0]['cep_socio']) ?? '' ?>" maxlength="8">
                </div>

                <div class="margin">
                    <label for="uf_socio">UF de residência</label><br>
                    <input type="text" name="uf_socio" id="uf_socio" required autocomplete="random-string" value="<?= ($socios[0]['uf_socio']) ?? '' ?>" readonly>
                </div>

                <div class="margin">
                    <label for="cidade_socio">Município de residência</label><br>
                    <input type="text" name="municipio_socio" id="municipio_socio" required autocomplete="random-string" value="<?= ($socios[0]['municipio_socio']) ?? '' ?>" readonly>
                </div>
                ...
                <div class="margin">
                    ...
                    <input type="text" name="bairro_socio" id="bairro_socio" required autocomplete="random-string" value="<?= ($socios[0]['bairro_socio']) ?? '' ?>">
                </div>
            </div>
