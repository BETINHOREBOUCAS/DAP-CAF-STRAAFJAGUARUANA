        ...
        <fieldset>
            ...
            <div class="displayFlex">
                <div class="margin">
                    ...
                    <input type="text" name="cep_socio" id="inputCEP2" required autocomplete="random-string" maxlength="8">
                </div>

                <div class="margin">
                    <label for="uf_socio">UF de residência</label><br>
                    <input type="text" name="uf_socio" id="uf_socio" required autocomplete="random-string" readonly>
                </div>

                <div class="margin">
                    <label for="cidade_socio">Município de residência</label><br>
                    <input type="text" name="municipio_socio" id="municipio_socio" required autocomplete="random-string" readonly>
                </div>
