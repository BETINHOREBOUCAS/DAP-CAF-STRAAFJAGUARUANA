    ...
    <fieldset>
        ...
        <div class="displayFlex">
            ...
            <div class="margin">
                ...
                <input required type="text" name="areaTotal" id="areaTotal" maxlength="6" value="<?= isset($propriedade) && !empty($propriedade) ? $propriedade[0]['areaTotal'] : ''; ?>">
            </div>
            <div class="margin">
                <label for="are">Área Plantada</label>
                <input required type="text" name="area" id="area" maxlength="6" value="<?= isset($propriedade) && !empty($propriedade) ? $propriedade[0]['area'] : ''; ?>">
            </div>
        </div>
        <div class="displayFlex">
            <div class="margin">
    ...
    <fieldset>
        ...
        <div class="displayFlex">
            <div class="margin">
                ...
                <input type="text" name="endereco_RLegal" id="endereco_RLegal" value="<?= isset($propriedade) && !empty($propriedade) ? $propriedade[0]['endereco_RLegal'] : ''; ?>">
            </div>
            <div class="margin">
                <label for="bairro_RLegal">Bairro do Representante Legal</label>
                <input type="text" name="bairro_RLegal" id="bairro_RLegal" value="<?= isset($propriedade) && !empty($propriedade) ? $propriedade[0]['bairro_RLegal'] : ''; ?>">
            </div>
        </div>
    </fieldset>
